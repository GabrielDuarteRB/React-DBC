import styles from './CienciaTecnologia.module.css'
import {FaSistrix, FaBars} from 'react-icons/fa'
import Buttons from '../../components/Buttons/Buttons'

const headerCienciaTecnologia = () =>{
    return(
        <header>
        <div className={styles.headerCienciaTecnologiaFirst}>
            <div>
                <span>
                    <FaBars/>
                </span>
        ...
        <div className={styles.headerCienciaTecnologiaSecond}>
            <div>
                <h2>Science</h2>
            </div>
        </div>
...
export default headerCienciaTecnologia